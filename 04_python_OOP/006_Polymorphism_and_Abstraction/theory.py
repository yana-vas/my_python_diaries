...
# Polymorphism - на различни видове обекти, които имат един и общи корен(метод), но различни форми(функции).
# Имаме възможността да извикваме един и същи метод, върху различни инстанции
